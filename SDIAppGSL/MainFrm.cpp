...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSDIAppGSLView), CSize(0, 0), pContext);

	SetActiveView((CView*)m_wndSplitter.GetPane(0, 1));

	CSDIAppGSLDoc* pDoc = (CSDIAppGSLDoc*)GetActiveDocument();

	pDoc->m_pTreeView = (CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	pDoc->m_pView = (CSDIAppGSLView*)m_wndSplitter.GetPane(0, 1);
